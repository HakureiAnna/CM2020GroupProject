...
CREATE TABLE plans(
	...
	breakfast_uri VARCHAR(2048) NOT NULL,
	breakfast_image VARCHAR(2048) NOT NULL,
	breakfast_calories INT NOT NULL,
	lunch_name VARCHAR(256) NOT NULL,
	lunch_uri VARCHAR(2048) NOT NULL,
	lunch_image VARCHAR(2048) NOT NULL,
	lunch_calories INT NOT NULL,
	dinner_name VARCHAR(256) NOT NULL,
	dinner_uri VARCHAR(2048) NOT NULL,
	dinner_image VARCHAR(2048) NOT NULL,
